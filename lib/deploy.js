...
async function connectSSH(config) {
  const { host, port, username, password, sshAgent, privateKey, passphrase, distPath } = config;
  const sshConfig = sshAgent ? { host, port, username, agent: process.env.SSH_AUTH_SOCK } : {
    host,
    port,
    username,
    password,
